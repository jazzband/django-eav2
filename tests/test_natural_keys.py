...
class ModelTest(TestCase):
    ...
    def test_enum_group_natural_keys(self):
        ...
        enum_group_retrieved_model = EnumGroup.objects.get_by_natural_key(*enum_group_natural_key)
    ...
    def test_enum_value_natural_keys(self):
        ...
        enum_value_retrieved_model = EnumValue.objects.get_by_natural_key(*enum_value_natural_key)
